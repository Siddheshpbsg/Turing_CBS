...
public class ChequeBookIssued 
{
	public String location;
	public String statement;
	Properties properties;

	public ChequeBookIssued(Properties properties)
	{
	...
	{
		try {
			Login.driver.findElement(By.xpath("//input[@id='myInput']")).sendKeys("Cheque Book Issued");
			Login.driver.findElement(By.xpath("//li[@class='ulChild']/a[contains(text(),' Cheque Book Issued')]"))
					.click();
			Thread.sleep(3000);
			...
			int colcount = Login.sheet.getRow(1).getLastCellNum();
			Login.row = Login.sheet.getRow(1);
			...
			FileUtils.copyFile(file,
					new File("D:\\Siddhesh Training Document\\Automation_For_CBS\\MIS Screenshot\\screen1.jpg"));
		} catch (Exception ex) {
			System.out.println();
		}
	}
