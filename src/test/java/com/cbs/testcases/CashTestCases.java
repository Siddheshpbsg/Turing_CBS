...
//======================================CASA credit/Debit/Close ===============================================================
	...
	@Test(dependsOnMethods = { "CasaClose" })
	...
	@Test(dependsOnMethods = { "authorizedCasaClose" })
...
//	}
	...
	// ============================================Internal Product/Account credit
	// debit ====================================
...
//	  properties.getProperty("maker_password")); cashPage = homepage.clickOnCash();
//	  Thread.sleep(3000); // cashPage.MultipleACCredit(); }

//	@Test(priority = 7)
//	public void authMultipleACCreditTest() throws Exception {
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("checker"), properties.getProperty("checker_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(5000);
//		cashPage.authMultipleACCredit();
//	}

//	@Test(priority = 1)
//	public void casaCreditInMultipleACTest() throws Exception {
//		cashPage.casaCreditInMultipleAC();
//		//cashPage.casaCredit();
//	}

//	@Test(priority = 35)
//	public void casaCreditCancalAuthorizationtest() throws Exception {
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(5000);
//		cashPage.casaCreditCancalAuthorization();
//	}
//
//	@Test(priority = 36)
//	public void casaCreditRejectTest() throws Exception {
//
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(5000);
//		cashPage.casaCreditReject();
//	}
//
//	@Test(priority = 37)
//	public void authCasaCreditRejectTest() throws Exception {
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("checker"), properties.getProperty("checker_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(5000);
//		cashPage.authCasaCreditReject();
//	}

	@Test(priority = 38)
	public void addmultuiplecredit1Test() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(3000);
	...
	@Test(priority = 39)
	public void authaddmultuiplecredit1Test() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("checker"), properties.getProperty("checker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(3000);
		cashPage.authaddmultuiplecredit1();
	}

	@Test(priority = 40)
	public void cashReversalTest() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(3000);
		cashPage.cashReversal();
	}

	@Test(priority = 41)
	public void authcashReversalTest() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("checker"), properties.getProperty("checker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(5000);
		cashPage.authCashReversal();
	}

	@Test(priority = 42)
	public void CCaccountCreditTest() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(3000);
		cashPage.CCaccountCredit();
	}

	@Test(priority = 43)
	public void authCCaccountCredittest() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("checker"), properties.getProperty("checker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(5000);
		cashPage.authCCaccountCredit();
	}

	@Test(priority = 44)
	public void CCaccountDebitTest() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(3000);
		cashPage.CCaccountDebit();
	}

	@Test(priority = 45)
	public void authCCaccountDebitTest() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("checker"), properties.getProperty("checker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(5000);
		cashPage.authCCaccountDebit();
	}

	@Test(priority = 46)
	public void CCaccountDebitPendingDenomsTest() throws Exception {
		loginpage = new LoginPage();
		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
		cashPage = homepage.clickOnCash();
		Thread.sleep(3000);
		cashPage.CCaccountDebitPendingDenoms();
	}

//====================================================Test47, 48, 49 not working	
//	@Test(priority = 47)
//	public void CCaccountCloseTest() throws Exception {
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(3000);
//		cashPage.CCaccountClose();
//	}
//
//	@Test(priority = 48)
//	public void authCCaccountCloseTest() throws Exception {
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("checker"), properties.getProperty("checker_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(5000);
//		cashPage.authCCaccountClose();
//	}
//
//	@Test(priority = 49)
//	public void CCaccountClosePendingDenomsTest() throws Exception {
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(3000);
//		cashPage.CCaccountClosePendingDenoms();
//	}

//	@Test(priority = 50)
//	public void cashTransitTest() throws Exception {
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("maker"), properties.getProperty("maker_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(3000);
//		cashPage.cashTransit();
//	}
//
//	@Test(priority = 51)
//	public void authCashTransitTest() throws Exception {
//		loginpage = new LoginPage();
//		homepage = loginpage.makerLogin(properties.getProperty("makerotherBranch"),
//				properties.getProperty("makerotherBranch_password"));
//		cashPage = homepage.clickOnCash();
//		Thread.sleep(3000);
//		cashPage.authCashTransit();
//	}
